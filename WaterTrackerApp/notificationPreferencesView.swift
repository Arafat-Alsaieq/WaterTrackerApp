...
struct notificationPreferencesView: View {
    ...
    @State private var navigateToWaterTracker = false // State to trigger navigation
    ...
    var body: some View {
        NavigationView {
            VStack {
                ...
                HStack {
                    VStack(alignment: .leading) {
                        ...
                        DatePicker("Start Time", selection: $startTime, displayedComponents: [.hourAndMinute])
                            .labelsHidden() // If there's an error here, remove this line to check
                    }
                ...
                NavigationLink(
                    destination: WaterTracker(dailyGoal: 2.7), // Pass the appropriate dailyGoal here
